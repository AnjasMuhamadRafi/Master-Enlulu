...
@section('title', 'Report Karyawan Fraud')
@section('page-title', 'Report Karyawan Fraud')

@section('content')
<div class="page-header mb-4">
    <div class="row align-items-center">
        <div class="col">
            <h1 class="h3 text-dark"><i class="bi bi-shield-exclamation" style="color: #6f0000; margin-right: 8px;"></i> Report Karyawan Fraud</h1>
        </div>
        <div class="col-auto">
            <a href="{{ route('employee.export', ['status' => 'Fraud']) }}" class="btn btn-success">
            ...
            <tbody>
                @foreach($employees as $employee)
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-dark">{{ $employee->status ?? 'Fraud' }}</span>
                        </td>
                    </tr>
                @endforeach
            </tbody>
...
@else
    <div class="alert alert-info" role="alert">
        <i class="bi bi-info-circle"></i> Tidak ada data karyawan fraud yang ditemukan.
    </div>
@endif
