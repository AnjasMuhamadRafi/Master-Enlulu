                ...
                <div class="tab-content">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat" placeholder="Jl. Semangat RT.011/01 No.18" value="{{ old('alamat') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('propinsi') is-invalid @enderror" name="propinsi" value="{{ old('propinsi') }}">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('ec_nama') is-invalid @enderror" name="ec_nama" value="{{ old('ec_nama') }}">
                            @error('ec_nama')<span class="invalid-feedback d-block">{{ $message }}</span>@enderror
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Tempat Tinggal</label>
                            <input type="text" class="form-control @error('ec_alamat') is-invalid @enderror" name="ec_alamat" value="{{ old('ec_alamat') }}">
                            @error('ec_alamat')<span class="invalid-feedback d-block">{{ $message }}</span>@enderror
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">No. HP</label>
                            <input type="text" class="form-control @error('ec_no_hp') is-invalid @enderror" name="ec_no_hp" value="{{ old('ec_no_hp') }}">
